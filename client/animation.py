...
class Animation:
    ...
    STARTED = 1
    ENDED = 2
    def __init__(self, duration, start_value, end_value, start_delay=0):
    ...
    def start(self):
        ...
        self.onTick(self.start_value)
        
    def update(self):
        if self.state != Animation.STARTED:
            return
        instant = pygame.time.get_ticks() - self.start_time - self.start_delay
        if instant < 0:
            return
